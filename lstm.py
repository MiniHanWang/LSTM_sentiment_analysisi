...
#pos=pd.read_excel('nue.xls',header=None,index=None)
pos['mark']=1
...
acc = keras.metrics.accuracy(classes, yt)
print('Test accuracy:', acc)
pd.DataFrame(acc).to_excel(r'G:\projects\me\博士\股票\LSTM\lstm_1\lstm_result.xlsx')